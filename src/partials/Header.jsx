        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
              ...
              <li>
                <Link to="/pricing" className="text-lg underline underline-offset-1  hover:text-yellow-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">Pricing</Link>
              </li>
              <li>
                <Link to="/blog" className="text-lg underline underline-offset-1  hover:text-yellow-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">Blog</Link>
              </li>
              <li>
                <Link to="/about" className="text-lg underline underline-offset-1  hover:text-yellow-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">About us</Link>
              </li>
              <li>
                <Link to="/contact" className="text-lg underline underline-offset-1  hover:text-yellow-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">Contact us</Link>
              </li>
              <li>
                <Link to="/help" className="text-lg underline underline-offset-1  hover:text-yellow-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">FAQ</Link>
              </li>
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link to="/signin" className="font-medium  hover:text-yellow-600 px-4 py-3 flex items-center transition duration-150 ease-in-out">Sign in</Link>
              </li>
              <li>
                <Link to="/signup" className="btn-sm text-black hover:text-gray-50 bg-yellow-300 hover:bg-yellow-600 ml-3">Sign up</Link>
              </li>
            </ul>
          ...
          <div className="md:hidden">
            ...
            <button ref={trigger} className={`hamburger ${mobileNavOpen && 'active'}`} aria-controls="mobile-nav" aria-expanded={mobileNavOpen} onClick={() => setMobileNavOpen(!mobileNavOpen)}>
              ...
              <svg className="w-6 h-6 fill-current text-purple-900 hover:text-yellow-600 transition duration-150 ease-in-out" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
